  ...
  <body>
    <header class="header">
      <nav class="header__menu">
        <ul class="header__links-list">
          ...
          <li class="header__links-list-item">
            <a href="/lots" class="header__link">посмотреть лоты</a>
          </li>
          <li class="header__links-list-item">
            <a href="/auctions" class="header__link">об аукционе</a>
          </li>
        </ul>
      </nav>
      ...
      <address class="address header__address">
        <a href="tel:+99995555555"> +9 999 555 55 55 </a>
        <br />
      ...
      <section class="cover">
        ...
        <h1 class="cover__title">
          <span class="aligned-text letter-spacing-extended"
            >Он<span class="no-letter-spacing">о</span></span
          >
          <span class="aligned-text_center letter-spacing-extended"
            >теб<span class="no-letter-spacing">е</span></span
          >
          <span class="aligned-text_right letter-spacing-extended"
            >над<span class="no-letter-spacing">о</span></span
          >
        </h1>
    ...
    <footer class="footer">
      ...
      <nav class="footer__menu">
        <ul class="footer__menu-list">
          ...
          <li class="footer__menu-list-item">
            <a href="/lots" class="footer__menu-link">посмотреть лоты</a>
          </li>
          <li class="footer__menu-list-item">
            <a href="/auctions" class="footer__menu-link">об аукционе</a>
          </li>
        </ul>
      </nav>
